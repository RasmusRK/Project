...
if (_root.accessID == 1) {
	...
	sendVars.sendAndLoad("http://www.ekgl.dk/booking/OYXVC/removePassengerTime.php", loadedVars, "POST");
}
	// Ellers er det eleven selv som afbestiller.
else {
	bInfo = bookingsText[time-1].split("\n");
	sendVars.info = bInfo[0] + "\n" + bInfo[1] + "\n" + bInfo[2] + "\n" + bInfo[3];
	sendVars.sendAndLoad("http://www.ekgl.dk/booking/OYXVC/removePassengerTimeByPassenger.php", loadedVars, "POST");	
}
	// Tænkefilm synlig.
