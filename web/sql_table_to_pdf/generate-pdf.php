...
$pdf->Table('SELECT `project_name`, `category`,`start_date`,`end_date`,`info` from projekt order by `project_name`');
$pdf->AddPage();
...
$prop=array('HeaderColor'=>array(255,150,100),
			...
			'padding'=>2);
$pdf->Table('select project_name, category,start_date, end_date, info from projekt order by project_name limit 0,10',$prop);
