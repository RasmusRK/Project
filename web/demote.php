...
<?php if ($_REQUEST['uid'] > 0 && get_userState($mysqli, $_REQUEST['uid']) == 1) : ?>
    ...
    <div id="main">
        ...
        <div class="content">            
            <form>
                Er du sikker på du ønsker, at gøre adminstratoren med id: <?php echo $uid; ?> til en normal bruger?
                ...
                <?php
                    if (isset($_REQUEST['ja'])) {                        
                        mysqli_query($mysqli,"UPDATE users SET admin = 0    
                                              WHERE id = $uid");
